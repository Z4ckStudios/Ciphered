...
var CipheredZS = document.getElementById("GmtlivihZS");
...
function timerInt() {
    ...
    if(timer > 0) {
        CipheredZS.innerHTML = "_";
    }
    if(timer > 20) {
        CipheredZS.innerHTML = "";
    }
    if(timer > 40) {
        CipheredZS.innerHTML = "_";
    }
    ...
    if(timer > 122) {
        CipheredZS.innerHTML = "Gmtlivih - D4go Wxyhmsw";
    }
    ...
    if(timer > 147) {
        CipheredZS.innerHTML = "Flskhuhg - C4fn Vwxglrv";
    }
    ...
    if(timer > 167) {
        CipheredZS.innerHTML = "Ekrjgtgf - B4em Uvwfkqu";
    }
    ...
    if(timer > 187) {
        CipheredZS.innerHTML = "Djqifsfe - A4dl Tuvejpt";
    }
    ...
    if(timer > 207) {
        CipheredZS.innerHTML = "Ciphered - Z4ck Studios";
    }
